            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="pr-0 md:pr-10 lg:pr-36">
                        ...
                        <p className="mb-4 text-sm md:text-base font-normal font-jakarta-sans text-justify">
                    ...
                    <div className="pl-0 md:pl-10 lg:pl-36">
                        ...
                        <ul>
                            <li className="mb-4 text-sm font-normal font-jakarta-sans">
                    ...
                    <div className="pl-0 md:pl-10 lg:pl-36 text-neutral-50">
                        ...
                        <ul>
                            <li className="mb-4 text-sm font-normal font-jakarta-sans">Jalan: Jl.TourEase No.205A</li>
                            <li className="mb-4 text-sm font-normal font-jakarta-sans">No Telepon: 123 456 7890</li>
                            <li className="mb-4 text-sm font-normal font-jakarta-sans">Email: TourEase@gmail.com</li>
                            <li className="mb-4 text-sm font-normal font-jakarta-sans">Maps: Malang, Jawa Tengah</li>
                        </ul>
                    </div>
                </div>
            </div>
