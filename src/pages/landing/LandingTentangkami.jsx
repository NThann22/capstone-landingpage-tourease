        ...
        <div className="container mx-auto py-10 px-4 md:px-0">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 py-10 md:py-[105px]">
                ...
                <div className="flex flex-col justify-center px-5 py-10 md:py-20">
                    <h2 className="text-3xl md:text-4xl font-bold text-primary-500 mb-6 md:mb-[30px] font-jakarta-sans">Tentang Kami</h2>
                    <p className="text-sm md:text-base font-medium text-neutral-900 font-jakarta-sans leading-relaxed">
