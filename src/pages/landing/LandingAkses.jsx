        ...
        <section className="container mx-auto py-10 px-4 md:px-0">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-28 py-10 md:py-20">
                <div className="flex flex-col justify-center items-center md:items-start px-4 md:px-8">
                    <h2 className="text-2xl md:text-4xl font-bold text-primary-500 mb-8 md:mb-12 font-jakarta-sans">Dapatkan Akses Langsung Di Aplikasi Kami</h2>
                    <p className="text-base md:text-lg font-normal text-neutral-900 mb-8 md:mb-12 max-w-md font-jakarta-sans">
